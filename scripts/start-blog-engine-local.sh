...
export OPENAI_MAX_OUTPUT_TOKENS="${OPENAI_MAX_OUTPUT_TOKENS:-5000}"
...
export OLLAMA_MAX_OUTPUT_TOKENS="${OLLAMA_MAX_OUTPUT_TOKENS:-1200}"
export OLLAMA_REQUEST_TIMEOUT_MS="${OLLAMA_REQUEST_TIMEOUT_MS:-240000}"
...
export CONTENT_DASHBOARD_INDEXNOW_ENABLED="${CONTENT_DASHBOARD_INDEXNOW_ENABLED:-${CONTENT_DASHBOARD_INDEXNOW_KEY:+true}}"
export CONTENT_DASHBOARD_INDEXNOW_ENABLED="${CONTENT_DASHBOARD_INDEXNOW_ENABLED:-false}"
export CONTENT_DASHBOARD_INDEXNOW_HOST="${CONTENT_DASHBOARD_INDEXNOW_HOST:-certifyd.me}"
export CONTENT_DASHBOARD_INDEXNOW_PUBLIC_URL="${CONTENT_DASHBOARD_INDEXNOW_PUBLIC_URL:-https://certifyd.me}"
...
echo "IndexNow: ${CONTENT_DASHBOARD_INDEXNOW_ENABLED}"
