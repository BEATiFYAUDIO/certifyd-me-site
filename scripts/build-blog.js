...
function homepageStyles() {
  return `${HOME_CSS_START}
    ...
    .social-home-kicker{display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin:0 0 12px}
    .social-home-new{display:inline-flex;align-items:center;border:1px solid rgba(255,190,94,.54);border-radius:999px;background:rgba(255,138,0,.13);color:var(--certifyd-orange);font-size:11px;font-weight:900;letter-spacing:.14em;padding:5px 9px;text-transform:uppercase}
